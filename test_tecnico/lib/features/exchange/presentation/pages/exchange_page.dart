...
import 'package:test_tecnico/features/exchange/presentation/helpers/currency_types.dart';
                      ...
                      return Column(
                        ...
                        children: [
                          ExchangeHeader(
                            ...
                            rightCode: s.toCode,
                            onLeftTap: () =>
                                _openSheet(context, selectFrom: true),
                            onRightTap: () =>
                                _openSheet(context, selectFrom: false),
                            onSwap: () => context.read<ExchangeBloc>().add(
                              const SwapRequested(),
                            ),
                          ),
                          ...
                          AmountField(
                            ...
                            prefix: s.fromCode,
                            borderColor: brand,
                            onChanged: (v) => context.read<ExchangeBloc>().add(
                              AmountChanged(v),
                            ),
                          ),
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () => context.read<ExchangeBloc>().add(
            ...
            child: Column(
              ...
              children: [
                ...
                Section(
                  title: 'FIAT',
                  children: fiats
                      .map((c) => _tile(context, c, selectFrom))
                      .toList(),
                ),
                const SizedBox(height: 8),
                Section(
      ...
      onTap: () {
        ...
        if (selectFrom) {
          context.read<ExchangeBloc>().add(
            FromCurrencySelected(code: c.code, isCrypto: isCrypto),
          );
        } else {
          context.read<ExchangeBloc>().add(
            ToCurrencySelected(code: c.code, isCrypto: isCrypto),
          );
        }
      },
